...
function getUserLanguageIds() {
  try {
    let usersLanguageIDs = atom.config.get("iansasciidoc-preview-frommarkdownpreview.customSyntaxHighlightingLanguageIdentifiers");
...
function getLanguageIds() {
  ...
  let preferredLanguageID = atom.config.get("iansasciidoc-preview-frommarkdownpreview.syntaxHighlightingLanguageIdentifier");
